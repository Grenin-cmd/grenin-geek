 // Lista de produtos (EXEMPLO — troque nome, categoria, código, preço e descrição)
  const PRODUCTS = [
    ...
    { name: "Bleach Remix Vol. 2", category: "mangas", price: 45, desc: "Usado" },
    { name: "Bleach Remix Vol. 3", category: "mangas", price: 45, desc: "Usado" },
   { name: "Bleach Remix Vol. 4", category: "mangas", price: 45, desc: "Usado." },
{ name: "Bleach Remix Vol. 5", category: "mangas", price: 45, desc: "Usado." },
