 // Lista de produtos (EXEMPLO — troque nome, categoria, código, preço e descrição)
  const PRODUCTS = [
    ...
    { name: "Coleção Arco-Iris Evolções Prismaticas", category: "pokemon-tcg", price: 210, desc: "Caixa fechada, 10 pacotes", image:"assets/produtos/box-eevee.jpg" },
   { name: "Blister Unitário Equilíbrio Perfeito ", category: "pokemon-tcg", price: 13, desc: "Booster unico", image:"assets/produtos/buniequperf.jpg" },
{ name: "Blister Unitário Escuridão Absoluta ", category: "pokemon-tcg", price: 13, desc: "Booster unico", image:"assets/produtos/bunicoescabs.jpg" },
...
{ name: "Gantz Vol. 4", category: "mangas", price: 27, desc: "Novo.", image:"assets/produtos/gantz4.jpg" },
